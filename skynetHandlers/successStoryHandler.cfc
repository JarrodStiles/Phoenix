							...
							<form id="sendSuccessStory" method="post" class="ajaxForm wait">
								<fieldset class="accountInfo">
									...
									<ul class="left">
										...
										<li class="scs_story">
											<textarea name="story" class="input.focus r"></textarea>
										</li>
									</ul>
									<p class="terms">
										<input name="successStory_agreeTerms" type="checkbox" value="" class="input.focus r" />
										Please read and agree to <a id="slidePanel_next" class="panel.next click">Let us use your story</a> <a id="sendSuccessStory_submit" class="form.validate click scs_submit">Submit</a></p>
								</fieldset>
							</form>
						</div>
						<div class="slide2">
							...
							<p><a id="slidePanel_prev" class="panel.prev click scs_agree" onClick="$('input[name=successStory_agreeTerms]').attr('checked', true)">Agree</a></p>
						</div>
					</div>
				</div>
			</div>
